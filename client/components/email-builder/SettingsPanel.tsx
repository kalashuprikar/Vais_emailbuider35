            ...
            {selectedCard && (
              <>
                <div>
                  ...
                  <Input
                    id="cardTitle"
                    value={selectedCard.title || (selectedCard.titles?.[0]?.content || "")}
                    onChange={(e) => {
                      if (selectedCard.titles && selectedCard.titles.length > 0) {
                        // Update first title in array
                        const updatedCards = twoColBlock.cards.map((card: any) =>
                    ...
                    className="w-full focus:ring-valasys-orange focus:ring-2"
                  />
                  <p className="text-xs text-gray-500 mt-1">Use the card editor to add multiple titles or duplicate them</p>
                </div>
